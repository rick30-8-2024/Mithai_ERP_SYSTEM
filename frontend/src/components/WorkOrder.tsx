            ...
            >
              ...
              <div style={{ padding: 18, borderBottom: "1px solid var(--border)" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                  ...
                  <Info label="Actual Qty" value={`${wo.actual_quantity} ${wo.recipe.yield_unit}`} />
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                  ...
                  <div>
                    <div style={{ fontSize: 11, color: "var(--muted)", fontWeight: 800, marginBottom: 4 }}>Priority</div>
              ...
              >
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 2 }}>
                    Required: {ingredient.required_quantity} {ingredient.unit} → Actual: {ingredient.actual_quantity} {ingredient.unit}
                  </div>
                </div>
